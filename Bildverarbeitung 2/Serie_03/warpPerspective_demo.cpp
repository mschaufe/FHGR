...
{
	help(argv);
	CommandLineParser parser(argc, argv, "{@input| D:/birkudo/Pictures/openCV/right.jpg |}");
	//CommandLineParser parser(argc, argv, "{@input| D:/birkudo/Pictures/openCV/sudoku.png |}");
	//CommandLineParser parser(argc, argv, "{@input| D:/birkudo/Pictures/publicDomain/chess-PIXNIO-181675-725x482.jpg |}");
	//CommandLineParser parser(argc, argv, "{@input| D:/birkudo/Pictures/fremde/DMC-TZ100-500µsec-rollingShutter.jpg |}");
